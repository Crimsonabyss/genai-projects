#!/usr/bin/env python3
"""
Optimized Qdrant Vector Storage for Qwen3 Embeddings
...
class OptimizedQdrantVectorStore:
    """
    Optimized Qdrant setup for Qwen3embeddings
    - 2560 dimensions
    ...
    def __init__(
        ...
        self.vector_size = 2560  # Qwen3 embedding size
        
    def get_embedding(self, text: str) -> List[float]:
        """Get embedding from your RooCode-compatible Qwen3 API"""
        try:
    ...
    def create_optimized_collection(self):
        """Create collection with optimal settings for Qwen3 vectors"""
        try:
