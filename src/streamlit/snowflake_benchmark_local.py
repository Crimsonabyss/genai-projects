...
def main():
    ...
    st.write("""You can ask questions about the document.""")
...
def get_chat_history(prompt_1st):    
    ...
    prompt_2nd = '''
        make sure the response is in json object with "Refined_question", "Answer", “Slide” as the keys. 
        # EXAMPLE #
        question: what dbs are included?
        answer: 
        {
            "Refined_question" : "What Database solutions are included in this benchmark report",
            "Answer" : "The databases are included in this benchmark report are .... "
            "Slide" : 31
        }'''
    chat_history.append({'role': 'user', 'content': prompt_2nd})
    chat_history.append({'role': 'assistant', 'content': ''})
...
def create_initial_prompt(file_name): 
    ...
    init_prompt = f"""
        ...
        -- respond in json object with "Refined_question", "Answer", “Slide” as the keys. 
        ...
        ############# 
        # RESPONSE # 
        json object with "Refined_question", "Answer", “Slide” as the keys. 
